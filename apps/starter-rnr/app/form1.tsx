...
import { FormCheckbox, FormInput, FormRadioGroup, FormRadioGroupItem, FormSelect, FormSwitch, FormTextarea } from '~/components/ui/form';
    ...
    >
      <View className='gap-7'>
        ...
        <FormRadioGroup
          ...
          name="radio" value="staff" onFocus={NopeFn} onBlur={NopeFn} onChange={NopeFn}
        >
          <FormRadioGroupItem radioValue='staff' label="staff" name="" onFocus={NopeFn} onBlur={NopeFn} />
          <FormRadioGroupItem radioValue='admin' label="admin" name="" onFocus={NopeFn} onBlur={NopeFn} />
          <FormRadioGroupItem radioValue='owner' label="owner" name="" onFocus={NopeFn} onBlur={NopeFn} />
        </FormRadioGroup>
        <FormSelect
